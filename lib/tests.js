...
function boardValid () {
  ...
  if (board.cells.length > 100) {//changed this from 36 to 100 to add more cells.
    displayMessage('The game can only cope with total number of cells up to 200! Try again with fewer cells.')
    return false
  }
